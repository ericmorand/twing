...
import {TwingNodeExpressionBinaryAdd, type} from "../../../../../../../../src/lib/node/expression/binary/add";
import {MockCompiler} from "../../../../../../../mock/compiler";

tape('node/expression/binary/add', (test) => {
    test.test('constructor', (test) => {
        let left = new TwingNodeExpressionConstant(1, 1, 1);
        let right = new TwingNodeExpressionConstant(2, 1, 1);
        let node = new TwingNodeExpressionBinaryAdd([left, right], 1, 1);
