...
import {GreaterOrEqualBinaryExpressionNode, type} from "../../../../../../../../src/lib/node/expression/binary/greater-equal";
...
tape('node/expression/binary/greater-equal', (test) => {
    test.test('constructor', (test) => {
        ...
        let node = new GreaterOrEqualBinaryExpressionNode([left, right], 1, 1);
